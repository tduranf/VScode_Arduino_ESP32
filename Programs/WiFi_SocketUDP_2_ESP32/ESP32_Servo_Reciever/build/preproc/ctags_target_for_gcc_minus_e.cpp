# 1 "/Users/tecla/Documents/Robotica/practiques/Projecte 2 Surgical Robotics/VScode_Arduino_ESP32/Programs/WiFi_SocketUDP_2_ESP32/ESP32_Servo_Reciever/ESP32_Servo_Reciever.ino"
# 2 "/Users/tecla/Documents/Robotica/practiques/Projecte 2 Surgical Robotics/VScode_Arduino_ESP32/Programs/WiFi_SocketUDP_2_ESP32/ESP32_Servo_Reciever/ESP32_Servo_Reciever.ino" 2
# 3 "/Users/tecla/Documents/Robotica/practiques/Projecte 2 Surgical Robotics/VScode_Arduino_ESP32/Programs/WiFi_SocketUDP_2_ESP32/ESP32_Servo_Reciever/ESP32_Servo_Reciever.ino" 2
# 4 "/Users/tecla/Documents/Robotica/practiques/Projecte 2 Surgical Robotics/VScode_Arduino_ESP32/Programs/WiFi_SocketUDP_2_ESP32/ESP32_Servo_Reciever/ESP32_Servo_Reciever.ino" 2
# 5 "/Users/tecla/Documents/Robotica/practiques/Projecte 2 Surgical Robotics/VScode_Arduino_ESP32/Programs/WiFi_SocketUDP_2_ESP32/ESP32_Servo_Reciever/ESP32_Servo_Reciever.ino" 2
  ...
  if (packetSize) {
    ...
    if (len > 0) {
      ...
      if (strcmp(device, "G7_Gri") == 0) {
        ...
        s1Status = doc["s1Status"] | 0x1;
        s2Status = doc["s2Status"] | 0x1;
        ...
        // ➤ Control PITCH
        float p = pitch;
        if (s1Status == 0x0 && s2Status == 0x0) {
          if (p > 0 && p < 90) p += 90;
          else if (p > 270 && p < 360) p -= 270;
          servo_pitch.write(((p)<(0)?(0):((p)>(180)?(180):(p))));
        }
        ...
        if (y > 180 && y <= 270) {
          ...
          if (s1Status == 0x0 && s2Status == 0x0) {
            servo_yaw.write(((y)<(0)?(0):((y)>(180)?(180):(y))));
          }
        }
      } else {
